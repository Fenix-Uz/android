...
object LanguageCode {
    ...
    private fun  initTitles() {
        ...
        titlesLanguages.add(TitleLanguages(357, "Contact support", "Support bilan bog'lanish", "Связаться с поддержкой"))
        ...
        titlesLanguages.add(TitleLanguages(364, "A legally registered technology company in Uzbekistan. We build Novagram and pay all taxes in full.", "O'zbekistonda rasman ro'yxatdan o'tgan texnologiya kompaniyasi. Biz Novagramni ishlab chiqamiz va barcha soliqlarni to'liq to'laymiz.", "Официально зарегистрированная в Узбекистане технологическая компания. Мы разрабатываем Novagram и платим все налоги в полном объёме."))
