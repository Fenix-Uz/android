...
public class ThemeColors {
    ...
    public static final int TELEGRAM_COLOR = 0xFF069DFD; // Novagram brand blue (matches the logo)
    public static final int TELEGRAM_COLOR_TEXT = 0xFF0B86D9; // Novagram brand blue, deeper for text contrast
    ...
    public static SparseArray<String> createColorKeysMap() {
        ...
        colorKeysMap.put(key_voipgroup_windowBackgroundWhiteInputFieldActivated,
        ...
        colorKeysMap.put(key_chat_reactionServiceButtonBackgroundSelected,
